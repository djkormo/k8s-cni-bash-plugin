...
APISERVER=https://10.0.0.1:$KUBERNETES_PORT_443_TCP_PORT # for AKS ?
...
curl -v --cacert ${CACERT} --header "Authorization: Bearer ${TOKEN}" -X GET ${APISERVER}/api/v1/nodes/$HOSTNAME
